...
from app.monitoring import (
    monitor_transaction, record_custom_metric, record_custom_event,
    DatabaseTrace, CacheTrace
)
...
async def submit_score(
    ...
    try:
        ...
        record_custom_metric("Leaderboard/ScoreSubmitted", submission.score)
        ...
        with DatabaseTrace("get_player_rank"):
            rank_query = text("""
                SELECT rank FROM (
